import { TInscription } from "./types";

const Inscription = ({ isEmailFieldOnError, isNameFieldOnError, isPasswordFieldOnError, handleSubmit, onSubmit, register }: TInscription) => (
